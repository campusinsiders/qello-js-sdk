...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.ContentsearchApi();
  });
  ...
  describe('ContentsearchApi', function() {
    describe('contentsearch', function() {
      it('should call contentsearch successfully', function(done) {
        //uncomment below and update the code to test contentsearch
        //instance.contentsearch(function(error) {
