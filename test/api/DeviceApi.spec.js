...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.DeviceApi();
  });
  ...
  describe('DeviceApi', function() {
    describe('updatePushId', function() {
      it('should call updatePushId successfully', function(done) {
        //uncomment below and update the code to test updatePushId
        //instance.updatePushId(function(error) {
