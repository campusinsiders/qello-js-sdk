...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.TimerApi();
  });
  ...
  describe('TimerApi', function() {
    describe('deleteTimer', function() {
      it('should call deleteTimer successfully', function(done) {
        //uncomment below and update the code to test deleteTimer
        //instance.deleteTimer(function(error) {
