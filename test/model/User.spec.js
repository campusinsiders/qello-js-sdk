...
(function(root, factory) {
  ...
  describe('User', function() {
    it('should create an instance of User', function() {
      ...
      //var instane = new QelloApi.User();
      //expect(instance).to.be.a(QelloApi.User);
    });
    ...
    it('should have the property serverTimeOffset (base name: "server_time_offset")', function() {
      // uncomment below and update the code to test the property serverTimeOffset
      //var instane = new QelloApi.User();
      //expect(instance).to.be();
    });
