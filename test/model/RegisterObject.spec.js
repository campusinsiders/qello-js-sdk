...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.RegisterObject();
  });
  ...
  describe('RegisterObject', function() {
    it('should create an instance of RegisterObject', function() {
      // uncomment below and update the code to test RegisterObject
      //var instane = new QelloApi.RegisterObject();
      //expect(instance).to.be.a(QelloApi.RegisterObject);
    });
