...
(function(root, factory) {
  ...
  describe('Retoken', function() {
    it('should create an instance of Retoken', function() {
      // uncomment below and update the code to test Retoken
      //var instane = new QelloApi.Retoken();
      //expect(instance).to.be.a(QelloApi.Retoken);
    });
