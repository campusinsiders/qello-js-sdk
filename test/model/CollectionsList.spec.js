...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.CollectionsList();
  });
  ...
  describe('CollectionsList', function() {
    it('should create an instance of CollectionsList', function() {
      // uncomment below and update the code to test CollectionsList
      //var instane = new QelloApi.CollectionsList();
      //expect(instance).to.be.a(QelloApi.CollectionsList);
    });
