...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.StatsList();
  });
  ...
  describe('StatsList', function() {
    it('should create an instance of StatsList', function() {
      // uncomment below and update the code to test StatsList
      //var instane = new QelloApi.StatsList();
      //expect(instance).to.be.a(QelloApi.StatsList);
    });
