...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.SearchAssetsList();
  });
  ...
  describe('SearchAssetsList', function() {
    it('should create an instance of SearchAssetsList', function() {
      // uncomment below and update the code to test SearchAssetsList
      //var instane = new QelloApi.SearchAssetsList();
      //expect(instance).to.be.a(QelloApi.SearchAssetsList);
    });
