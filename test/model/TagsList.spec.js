...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.TagsList();
  });
  ...
  describe('TagsList', function() {
    it('should create an instance of TagsList', function() {
      // uncomment below and update the code to test TagsList
      //var instane = new QelloApi.TagsList();
      //expect(instance).to.be.a(QelloApi.TagsList);
    });
