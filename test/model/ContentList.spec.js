...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.ContentList();
  });
  ...
  describe('ContentList', function() {
    it('should create an instance of ContentList', function() {
      // uncomment below and update the code to test ContentList
      //var instane = new QelloApi.ContentList();
      //expect(instance).to.be.a(QelloApi.ContentList);
    });
