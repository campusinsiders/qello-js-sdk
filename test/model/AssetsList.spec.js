...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.AssetsList();
  });
  ...
  describe('AssetsList', function() {
    it('should create an instance of AssetsList', function() {
      // uncomment below and update the code to test AssetsList
      //var instane = new QelloApi.AssetsList();
      //expect(instance).to.be.a(QelloApi.AssetsList);
    });
