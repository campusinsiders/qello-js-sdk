...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new QelloApi.ProfilesList();
  });
  ...
  describe('ProfilesList', function() {
    it('should create an instance of ProfilesList', function() {
      // uncomment below and update the code to test ProfilesList
      //var instane = new QelloApi.ProfilesList();
      //expect(instance).to.be.a(QelloApi.ProfilesList);
    });
