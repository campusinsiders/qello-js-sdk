...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QelloApi.Asset = factory(root.QelloApi.ApiClient, root.QelloApi.Asset);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('children')) {
        obj['children'] = ApiClient.convertToType(data['children'], [Asset]);
      }
    }
    return obj;
  }
  ...
  /**
   * Published or not
   * @member {module:model/Asset.PublishedEnum} published
   */
  exports.prototype['published'] = undefined;
  /**
   * Asset Metadata (type -> value)
   * @member {Object} meta
   */
  ...
  /**
   * Asset's Children Assets (for ex: Seasons for Shows) 
   * @member {Array.<module:model/Asset>} children
   */
