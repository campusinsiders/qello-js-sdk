...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SearchAssetsList', 'model/Status'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SearchAssetsList'), require('./Status'));
  } else {
    // Browser globals (root is window)
    if (!root.QelloApi) {
      root.QelloApi = {};
    }
    root.QelloApi.SearchResult = factory(root.QelloApi.ApiClient, root.QelloApi.SearchAssetsList, root.QelloApi.Status);
  }
}(this, function(ApiClient, SearchAssetsList, Status) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = SearchAssetsList.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/SearchAssetsList} data
   */
