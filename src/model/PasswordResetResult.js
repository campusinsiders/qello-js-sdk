...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.QelloApi.PasswordResetResult = factory(root.QelloApi.ApiClient, root.QelloApi.Status);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data')) {
        obj['data'] = Status.constructFromObject(data['data']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Status} data
   */
